        ...
        <Body className="bg-white font-sans mt-2">
          <Container className="max-w-[560px] mx-auto px-[24px] py-[48px] bg-[#FFFFFF] border border-solid border-neutral-300 rounded-lg">
            <Section className="text-center mb-6">
              <Img src="https://rovo.ai/icon.png" alt="Rovo AI" className="w-[48px] h-[48px] mx-auto mb-[24px]" />
            ...
            <Section className="text-center mb-[40px]">
              <Button
                href={`https://rovo.ai/search/${props.chatId}`}
            ...
            <Section className="text-center border-t border-solid border-black/30 pt-[32px]">
              <Img src="https://rovo.ai/icon.png" alt="Rovo AI" className="w-[32px] h-[32px] mx-auto mb-[16px]" />
              <Text className="text-[14px] text-[#6B7280] m-0">
                Rovo AI •{' '}
                <a href="https://rovo.ai" className="text-[#6B7280] no-underline">
                  rovo.ai
                </a>
              </Text>
            </Section>
