...
`
    : ''
}I am a current student at this university and would love to access the student discount for Rovo Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:haziqbangash@rovo.ai?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
