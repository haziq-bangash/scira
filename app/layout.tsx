...
export const metadata: Metadata = {
  metadataBase: new URL('https://rovo.ai'),
  title: {
    default: 'Rovo AI - Agentic Research Platform.',
    template: '%s | Rovo AI',
  },
  description:
    'Rovo is a free Agentic Research Platform that finds, analyzes, and cites information from the live web. $15/month—fast answers; 11000+ stars on GitHub.',
  openGraph: {
    url: 'https://rovo.ai',
    siteName: 'Rovo AI',
  },
