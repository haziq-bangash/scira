...
const PRO_FEATURES = [
  ...
  { icon: Eye, label: 'Rovo Lookout', description: 'Real-time monitoring' },
];
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 w-full">
      ...
      >
        ...
        {/* Content */}
        <h1 className="text-3xl font-medium text-foreground mb-3 tracking-tight">Welcome to Rovo Pro</h1>
